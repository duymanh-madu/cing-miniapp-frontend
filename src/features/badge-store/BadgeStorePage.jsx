...
const BADGE_STORE = [
  {
    ...
    color:"#7ab87a", bg:"linear-gradient(135deg,#3d6b3d,#5a9a5a,#7ab87a)", border:"rgba(122,184,122,0.5)",
    innerBg:"linear-gradient(135deg,#0a150a,#0f200f)", tier:"Cơ bản", category:"Hạng thành viên",
    condition:"Kích hoạt tài khoản thành công",
    upgrade:"Tiêu dùng tích lũy 1.000.000đ – 2.999.999đ để lên Thân Thiết",
  ...
  },
  {
    ...
    color:"#52b788", bg:"linear-gradient(135deg,#1a4d35,#2d6a4f,#52b788)", border:"rgba(82,183,136,0.5)",
    innerBg:"linear-gradient(135deg,#020e08,#041408)", tier:"Thân thiết", category:"Hạng thành viên",
  ...
  },
  {
    ...
    color:"#9ca3af", bg:"linear-gradient(135deg,#4b5563,#6b7280,#9ca3af)", border:"rgba(156,163,175,0.5)",
    innerBg:"linear-gradient(135deg,#080a0e,#0d1018)", tier:"Bạc ✦", category:"Hạng thành viên",
  ...
  },
  {
    ...
    color:"#f59e0b", bg:"linear-gradient(135deg,#78350f,#b45309,#f59e0b)", border:"rgba(245,158,11,0.6)",
    innerBg:"linear-gradient(135deg,#100800,#1e1000)", tier:"✦ Vàng ✦", category:"Hạng thành viên",
  ...
  },
  {
    ...
    color:"#a78bfa", bg:"linear-gradient(135deg,#0a2a5a,#1a50a0,#3a8adf,#80c0ff,#3a8adf)", border:"rgba(167,139,250,0.6)",
    innerBg:"linear-gradient(150deg,#04101e,#061828,#081e34)", tier:"Đẳng cấp tối thượng", category:"Đẳng cấp vương giả",
    condition:"Tiêu dùng tích lũy từ 10.000.000đ",
    upgrade:"Hạng cao nhất trong nhóm Hội viên",
    maintain:"Không yêu cầu duy trì",
    benefits:["Tích 10% điểm trên mỗi hóa đơn","Giảm 5% trên tổng hóa đơn","Đẳng cấp riêng biệt","Quà sinh nhật + Tri ân hàng tháng","Ưu tiên sự kiện độc quyền"],
  ...
  },
  {
    ...
    color:"#8b5cf6", bg:"linear-gradient(135deg,#4c1d95,#6d28d9,#8b5cf6)", border:"rgba(139,92,246,0.6)",
    innerBg:"linear-gradient(150deg,#08041a,#0f0628,#14082e)", tier:"✦ Đối tác ✦", category:"Hạng đối tác",
    ...
    discount:"3%", pointRate:"10%", permanent:false,
    royal:true, borderAnim:"linear-gradient(90deg,#4c1d95,#7c3aed,#c4b5fd,#7c3aed,#4c1d95)",
    glowAnim:"partnerGlowCard 2s ease-in-out infinite",
  },
  {
    key:"loyal_partner", label:"Đối Tác Thân Thiết", icon:"👑", stars:5,
    color:"#c084fc", bg:"linear-gradient(135deg,#4a0a28,#8a1a50,#d4537e,#ff90c0,#c080ff)", border:"rgba(192,132,252,0.6)",
    innerBg:"linear-gradient(150deg,#120608,#1e0a14,#160820)", tier:"Bất khả xâm phạm", category:"Đẳng cấp vương giả",
    ...
    benefits:["Tích 15% tổng tiêu dùng tháng thành điểm hoa hồng","Hoa hồng nhận ngay mỗi tháng","Giảm 5% trên tổng hóa đơn","Đặc quyền tuyệt đối","Quà tặng sinh nhật đặc biệt","Ưu tiên sự kiện độc quyền"],
  ...
  },
  {
    ...
    innerBg:"linear-gradient(150deg,#0e0900,#1a1000,#261800)", tier:"Vương giả cờ vua", category:"Danh hiệu đặc biệt · Live",
    condition:"Top 1 BXH Kỳ thủ cờ vua",
    upgrade:"Danh hiệu cao quý — không có cấp trên",
    maintain:"Duy trì vị trí Top 1 · Mất ngay khi bị vượt qua",
    benefits:["Danh hiệu LIVE — hiển thị trực tiếp","Biểu tượng ♟️ độc nhất","Xuất hiện nổi bật trong cộng đồng","Không thể mua — chỉ do thi đấu"],
  ...
  },
  {
    ...
    innerBg:"linear-gradient(155deg,#0a0005,#150008,#0a0005)", tier:"Đỉnh Phong Bất Bại", category:"Đại Sảnh Danh Vọng · Live",
    ...
    benefits:["Danh hiệu LIVE — thay đổi tức thì","Biểu tượng Ruby đỏ thẫm quyền uy","Khung viền lửa 5 sao","Nổi bật nhất trong cộng đồng","Không thể mua — chỉ do thực lực"],
    discount:"—", pointRate:"—", permanent:false, live:true,
  ...
  },
  {
    ...
    innerBg:"linear-gradient(155deg,#010208,#02040e,#010208)", tier:"Tinh Hoa Đệ Nhị", category:"Đại Sảnh Danh Vọng · Live",
    condition:"Top 2 BXH Tiêu dùng Alltime",
    upgrade:"Vươn lên Top 1 để đạt Vương Giả",
    maintain:"Duy trì vị trí Top 2 · Thay đổi tức thì khi BXH thay đổi",
    benefits:["Danh hiệu LIVE — thay đổi tức thì","Biểu tượng Sapphire xanh dương","Khung viền xanh 4 sao","Không thể mua — chỉ do thực lực"],
    discount:"—", pointRate:"—", permanent:false, live:true,
  ...
  },
  {
    ...
    innerBg:"linear-gradient(155deg,#010802,#020e04,#010802)", tier:"Tinh Hoa Đệ Tam", category:"Đại Sảnh Danh Vọng · Live",
    condition:"Top 3 BXH Tiêu dùng Alltime",
    upgrade:"Vươn lên Top 2 để đạt Phú Hào",
    maintain:"Duy trì vị trí Top 3 · Thay đổi tức thì khi BXH thay đổi",
    benefits:["Danh hiệu LIVE — thay đổi tức thì","Biểu tượng Emerald xanh lá quý phái","Khung viền xanh 4 sao","Không thể mua — chỉ do thực lực"],
    discount:"—", pointRate:"—", permanent:false, live:true,
    ...
    <div style={{ borderRadius:20, padding:isRoyal?"2.5px":"0", background:isRoyal?b.borderAnim:"transparent", backgroundSize:"400% 100%", animation:isRoyal?"royalBorder 1.8s linear infinite":"none" }}>
      <div style={{ borderRadius:isRoyal?18:20, padding:"20px 16px", background:isRoyal?b.innerBg:"#1a1a24", border:isRoyal?"none":`1px solid ${b.border}`, position:"relative", overflow:"hidden", boxSizing:"border-box" }}>
        ...
        <div style={{ marginTop:14, paddingTop:12, borderTop:"1px solid rgba(255,255,255,.07)" }}>
          ...
          <div style={{ marginBottom:10 }}>
            <p style={{ fontSize:10, color:"#555", margin:"0 0 4px", fontWeight:700, letterSpacing:1, textTransform:"uppercase" }}>⬆ Lên hạng tiếp</p>
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#0a0a0f", paddingBottom:80 }}>
      ...
      <style>{`
        ...
        @keyframes diamondGlowCard{0%,100%{box-shadow:0 0 22px 7px rgba(50,140,255,.55)}50%{box-shadow:0 0 50px 18px rgba(50,140,255,.9)}}
        @keyframes partnerGlowCard{0%,100%{box-shadow:0 0 18px 6px rgba(127,119,221,.5)}50%{box-shadow:0 0 40px 14px rgba(127,119,221,.88)}}
        @keyframes loyalPartnerGlowCard{0%,100%{box-shadow:0 0 22px 7px rgba(212,83,126,.55)}50%{box-shadow:0 0 50px 18px rgba(212,83,126,.92)}}
        @keyframes ktGlowCard{0%,100%{box-shadow:0 0 22px 7px rgba(186,117,23,.55)}50%{box-shadow:0 0 50px 18px rgba(186,117,23,.9)}}
