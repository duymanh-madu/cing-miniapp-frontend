...
export default function AlltimeLeaderboard({ onClose }) {
  ...
  return (
    <div style={{ position:"fixed", inset:0, zIndex:200,
      ...
      {/* Header sticky */}
      <div style={{ background:"linear-gradient(180deg,#050208,#0d0520)",
                  ...
                  <div onClick={() => goProfile(top3[1].user_id)}
                    ...
                    <div style={{ width:58, height:58, borderRadius:29, margin:"0 auto 6px",
                      ...
                      {top3[1].avatar
                        ...
                        : <div style={{width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",color:"#C0C0C0",fontSize:22,fontWeight:900}}>{(top3[1].player_name||"?")[0]}</div>}
                    </div>
                    <p style={{fontSize:11,color:"#C0C0C0",fontWeight:800,margin:"0 0 3px",
                  ...
                  <div onClick={() => goProfile(top3[2].user_id)}
                    ...
                    <div style={{ width:58, height:58, borderRadius:29, margin:"0 auto 6px",
                      ...
                      {top3[2].avatar
                        ...
                        : <div style={{width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",color:"#CD7F32",fontSize:22,fontWeight:900}}>{(top3[2].player_name||"?")[0]}</div>}
                    </div>
                    <p style={{fontSize:11,color:"#CD7F32",fontWeight:800,margin:"0 0 3px",
                      overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis",
                      maxWidth:85,marginLeft:"auto",marginRight:"auto"}}>
                      {top3[2].player_name||"?"}
                    </p>
