    ...
    <div style={{ position:"fixed", inset:0, zIndex:500, background:"#080810", display:"flex", flexDirection:"column" }}>
      ...
      {tab === "chat" ? (
        <div style={{ flex:1, overflowY:"auto", padding:"12px 16px", display:"flex", flexDirection:"column", gap:8 }}>
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display:"flex", flexDirection:"column", alignItems: isMe(m.userId)?"flex-end":"flex-start" }}>
              {<div style={{ display:"flex", alignItems:"center", gap:0, marginBottom:3, marginLeft:8,
              ...
              <div style={{ display:"flex", alignItems:"flex-end", gap:0, flexDirection: isMe(m.userId)?"row-reverse":"row" }}>
                {!isMe(m.userId) && (
        ...
        <div style={{ flex:1, overflowY:"auto", padding:"12px 16px" }}>
          {users.map((u, i) => (
            <div key={i} style={{ display:"flex", alignItems:"center", gap:0, padding:"10px 0", borderBottom:"1px solid rgba(255,255,255,0.04)" }}>
              ...
              <div>
                <div style={{ display:"flex", alignItems:"center", gap:0, cursor: isMe(u.userId)?"default":"pointer" }}
                  onClick={() => {
