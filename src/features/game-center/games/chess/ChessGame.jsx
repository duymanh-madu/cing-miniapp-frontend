            ...
            <div style={{ position:"relative", display:"flex", flexDirection:"column",
              ...
              {[...Array(16)].map((_,i) => (
                <div key={i} style={{
                  ...
                  height: tipResult.fromMe ? 55 : 95,
                  background: tipResult.fromMe
                    ? `linear-gradient(to top, transparent, rgba(255,215,0,${0.4+i%3*0.2}))`
                    : `linear-gradient(to top, transparent, rgba(100,200,255,${0.4+i%3*0.2}))`,
                  transformOrigin:"bottom center",
                  transform:`rotate(${i*22.5}deg) translateY(-${tipResult.fromMe?120:155}px)`,
                  borderRadius:2,
                }}/>
              ))}
              <div style={{
                background: tipResult.fromMe
                  ? "linear-gradient(145deg,#5a3a08,#b8840a,#FFD700,#FFF0A0,#FFD700,#b8840a,#5a3a08)"
                  : "linear-gradient(145deg,#0a1f3d,#0b4d8a,#1480c8,#6dc8f8,#1480c8,#0b4d8a,#0a1f3d)",
                borderRadius:24, padding:"28px 40px", textAlign:"center",
                boxShadow: tipResult.fromMe
                  ? "0 0 80px rgba(255,215,0,0.95), 0 0 160px rgba(255,215,0,0.4), 0 8px 40px rgba(0,0,0,0.9), inset 0 1px 0 rgba(255,255,255,0.5)"
                  : "0 0 80px rgba(30,160,255,0.95), 0 0 160px rgba(30,160,255,0.4), 0 8px 40px rgba(0,0,0,0.9), inset 0 1px 0 rgba(255,255,255,0.3)",
                border: `2px solid ${tipResult.fromMe?"rgba(255,245,160,0.9)":"rgba(160,220,255,0.9)"}`,
                ...
                <p style={{
                  ...
                  textShadow: tipResult.fromMe ? "0 1px 0 rgba(255,255,255,0.6)" : "0 1px 4px rgba(0,0,0,0.9)",
                }}>
                  {tipResult.giftName || "Vật phẩm"}
                </p>
                <p style={{
                  color: tipResult.fromMe ? "rgba(26,8,0,0.8)" : "rgba(210,245,255,0.95)",
                  fontSize:14, fontWeight:700, margin:"0 0 10px",
                }}>
                  {tipResult.fromMe ? "✨ Đã gửi đến đối thủ" : "🎁 Đối thủ vừa tặng bạn!"}
                </p>
                {!tipResult.fromMe && tipResult.charm > 0 && (
                  <div style={{ background:"rgba(0,0,0,0.25)", borderRadius:12,
                    padding:"8px 18px", display:"inline-block" }}>
                    <span style={{ color:"#FFD700", fontSize:16, fontWeight:900 }}>
                ...
                {tipResult.fromMe && (
                  <div style={{ background:"rgba(0,0,0,0.2)", borderRadius:12,
                    ...
                    <span style={{ color:"rgba(26,8,0,0.65)", fontSize:13, fontWeight:700 }}>
