...
export default function LeaderboardPage() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"linear-gradient(180deg,#050310 0%,#0d0820 35%,#080514 70%,#050310 100%)", paddingBottom:100 }}>
      ...
      {/* HEADER */}
      <div style={{ background:"linear-gradient(180deg,rgba(255,215,0,0.07),transparent)", padding:"0 16px 0", paddingTop:"max(env(safe-area-inset-top, 20px), 20px)", borderBottom:"1px solid rgba(255,215,0,0.08)" }}>
