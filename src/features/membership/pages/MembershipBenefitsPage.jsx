...
const TIERS = [
  {
    ...
    benefits: [
      ...
      { icon:"📱", text:"Quản lý đơn hàng trực tuyến" },
    ],
    discount: "0%",
    pointRate: "10%",
  },
  ...
  },
  {
    ...
    benefits: [
      ...
      { icon:"🎮", text:"Tham gia Game Center nhận thưởng" },
      { icon:"🎁", text:"Ưu đãi sinh nhật + quà tháng" },
      { icon:"🔔", text:"Thông báo flash sale ưu tiên" },
    ],
    discount: "2%",
    pointRate: "10%",
  },
  {
    ...
    benefits: [
      ...
      { icon:"🎮", text:"Tham gia Game Center + ưu tiên giải thưởng" },
      { icon:"🎁", text:"Quà sinh nhật cao cấp" },
      { icon:"🎯", text:"Voucher đặc quyền hàng tháng" },
      { icon:"📞", text:"Hỗ trợ ưu tiên" },
    ],
    discount: "3%",
    pointRate: "10%",
  },
  {
    ...
    benefits: [
      ...
      { icon:"🎁", text:"Quà sinh nhật kim cương + voucher VIP" },
      { icon:"🎯", text:"Voucher đặc quyền hàng tuần" },
      { icon:"📞", text:"Hotline chăm sóc riêng 24/7" },
  ...
  },
  {
    ...
    benefits: [
      { icon:"⭐", text:"Tích 10% điểm trên mỗi hóa đơn" },
      { icon:"💰", text:"Giảm 3% trên tổng hóa đơn" },
      { icon:"🤝", text:"Hỗ trợ đặc biệt từ đội ngũ Cing" },
      { icon:"🎁", text:"Quà tặng đặc quyền đối tác" },
  ...
  },
  {
    ...
    royalShimmer: true,
    benefits: [
      { icon:"⭐", text:"Tích 15% điểm trên mỗi hóa đơn" },
      { icon:"💰", text:"Giảm 5% trên tổng hóa đơn" },
      { icon:"👑", text:"Hạng đối tác cao nhất — đặc quyền tuyệt đối" },
      { icon:"🎁", text:"Quà tặng cao cấp hàng tháng" },
      { icon:"🎯", text:"Voucher đặc quyền không giới hạn" },
      { icon:"📞", text:"Account manager riêng" },
      { icon:"🏆", text:"Ưu tiên tuyệt đối mọi sự kiện" },
    ],
    discount: "5%",
    pointRate: "15%",
  },
