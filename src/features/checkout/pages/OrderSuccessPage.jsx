...
export default function OrderSuccessPage() {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center",
      ...
      <h1 style={{ fontSize:24, fontWeight:900, color:"#1a1a1a", margin:"0 0 8px" }}>Dat hang thanh cong!</h1>
      <p style={{ fontSize:14, color:"#666", margin:"0 0 32px", lineHeight:1.6 }}>
        Don hang cua ban dang duoc xu ly.<br/>Chung toi se thong bao khi co cap nhat.
      </p>
