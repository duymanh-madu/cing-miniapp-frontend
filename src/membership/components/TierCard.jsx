...
const TIER_CARD_CONFIG = {
  ...
  idol: {
    borderAnim: "linear-gradient(90deg,#5030ff,#b090ff,#ffffff,#b090ff,#5030ff)",
    innerBg:    "linear-gradient(150deg,#080418,#120828,#1a0a30)",
    badgeBg:    "linear-gradient(135deg,#5030ff,#8a70ff,#c0b0ff)",
    icon:       "✨",
    nameColor:  "#f0e8ff",
    subColor:   "#b090ff",
    label:      "Idol",
    royal:      true,
    glowColor:  "rgba(160,128,255,1)",
    glowColor2: "rgba(160,128,255,.6)",
    scanColor:  "rgba(210,190,255,.4)",
  },
  ngoi_sao: {
    borderAnim: "linear-gradient(90deg,#c08000,#ffd700,#ffffff,#ffd700,#c08000)",
    innerBg:    "linear-gradient(150deg,#120b00,#221500,#2c1b00)",
    badgeBg:    "linear-gradient(135deg,#ffd700,#ffe766,#fff3a0)",
    icon:       "⭐",
    nameColor:  "#fff3c4",
    subColor:   "#ffd700",
    label:      "Ngôi Sao",
    ...
    glowColor2: "rgba(255,215,0,.6)",
    scanColor:  "rgba(255,240,180,.4)",
  },
  minh_tinh: {
    borderAnim: "linear-gradient(90deg,#ff2060,#ff80b0,#ffffff,#ff80b0,#ff2060)",
    innerBg:    "linear-gradient(150deg,#180008,#280010,#320018)",
    badgeBg:    "linear-gradient(135deg,#ff2060,#ff80b0,#ffd0e0)",
    icon:       "🌟",
    nameColor:  "#ffe0f0",
    subColor:   "#ff80b0",
    label:      "Minh Tinh",
    royal:      true,
    glowColor:  "rgba(255,80,160,1)",
    glowColor2: "rgba(255,80,160,.6)",
    scanColor:  "rgba(255,200,220,.4)",
  },
};
