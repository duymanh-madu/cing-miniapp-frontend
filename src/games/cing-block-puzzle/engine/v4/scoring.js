...
perfectClearBonus(
  ...
  if (
    ...
    throw new TypeError(
      "perfect clear combo must be a positive safe integer"
    );
  }

  const bonus =
    SCORE.PERFECT_CLEAR_BASE +
    SCORE.PERFECT_CLEAR_COMBO_STEP *
      combo;
  ...
  if (
    ...
    throw new RangeError(
      "perfect clear bonus exceeds safe integer range"
    );
  }
...
export function scorePlacement({
  ...
  if (
    ...
    throw new TypeError(
      "perfect clear requires line clear"
    );
  }
